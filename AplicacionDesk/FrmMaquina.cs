    ...
    public partial class FrmMaquina : Form
    {
        ...
        private async void btnPost_Click(object sender, EventArgs e)
        {
            ...
            var datos = new
            {
                ...
                id_proceso = int.TryParse(txtIdProceso.Text, out var idProcesoValue) ? idProcesoValue : 0,
                id_ordenproduccion = int.TryParse(txtOrdenProduccion.Text, out var idOrdenProduccionValue) ? idOrdenProduccionValue : 0
            };
            bool success = await EjecutarPostPut(apiUrl, token, datos, HttpMethod.Post);
            MessageBox.Show(success ? "Máquina creada exitosamente." : "No se pudo crear la máquina.");
        }
        private async void btnPut_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(success ? "Máquina actualizada exitosamente." : "No se pudo actualizar la máquina.");
        }
