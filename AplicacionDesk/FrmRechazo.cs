...
{
    public partial class FrmRechazo : Form
    {
        public FrmRechazo()
        {
            InitializeComponent();
        ...
        private async void btnPost_Click(object sender, EventArgs e)
        {
            ...
            var datos = new
            {
                ...
                cantidadPR = int.TryParse(txtCantidadPR.Text, out var cantidadPRValue) ? cantidadPRValue : 0,
                fecha_Hora = dtpFechaHora.Value.ToString("yyyy-MM-ddTHH:mm:ss.fffZ"),
                descripcion = txtDescripcion.Text
            };
            bool success = await EjecutarPostPut(apiUrl, token, datos, HttpMethod.Post);
            MessageBox.Show(success ? "Rechazo creado exitosamente." : "No se pudo crear el Rechazo.");
        }
        private async void btnPut_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(success ? "Rechazo actualizado exitosamente." : "No se pudo actualizar el Rechazo.");
        }
    }
}
