    ...
    public partial class FrmProducto : Form
    {
        ...
        private async void btnPost_Click(object sender, EventArgs e)
        {
            ...
            var datos = new
            {
                ...
                calidad = txtCalidad.Text,
                fecha_Fin = dtpFechaFin.Value.ToString("yyyy-MM-ddTHH:mm:ss.fffZ"),
                descripcion = txtDescripcion.Text
            };
            bool success = await EjecutarPostPut(apiUrl, token, datos, HttpMethod.Post);
            MessageBox.Show(success ? "Producto creado exitosamente." : "No se pudo crear el Producto.");
        }
        private async void btnPut_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(success ? "Producto actualizado exitosamente." : "No se pudo actualizar el Producto.");
        }
    }
}