...
namespace AplicacionDesk
{
    public partial class FrmDepartamento : Form
    {
        ...
        private async void btnPost_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(success ? "Departamento creado exitosamente." : "No se pudo crear el departamento.");
        }
        private async void btnPut_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(success ? "Departamento actualizado exitosamente." : "No se pudo actualizar el departamento.");
        }
    }
}
